...
var _NewStudentForm = __webpack_require__(54);
...
var Main = function (_Component) {
    ...
    function Main(props) {
        ...
        _this.addNewStudent = _this.addNewStudent.bind(_this);
        return _this;
    }
    ...
    _createClass(Main, [{
        ...
        value: function addNewStudent(student) {
            ...
            _axios2.default.post('/student', student).then(function (res) {
                ...
                return _this3.setState({ //setting the state so that the new student appears immidiately
                    students: [].concat(_toConsumableArray(_this3.state.students), [student]) });
            }).catch(console.error);
        }
    }, {
        key: 'handleForm',
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                this.state.showForm ? _react2.default.createElement(_NewStudentForm2.default, { addNewStudent: this.addNewStudent }) : null
            );
        }
    }]);
...
var NewStudentForm = function (_Component) {
    ...
    _createClass(NewStudentForm, [{
        ...
        value: function handleChange(e) {
            //handles the changes for each input 
            this.setState(_defineProperty({}, e.target.name, e.target.value)); //[] is for bracket notation for objects.
        }
    }, {
        key: 'handleSubmit',
        value: function handleSubmit(e) {
            //set the state on submit 
            e.preventDefault();
            var student = {
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    this.state.firstName.match(/\d+/g) && _react2.default.createElement(
                        'div',
                        { className: 'alert alert-warning', style: { color: 'red' } },
                ...
                _react2.default.createElement(
                    ...
                    this.state.lastName.match(/\d+/g) && _react2.default.createElement(
                        'div',
                        { className: 'alert alert-warning', style: { color: 'red' } },
                        'Names cannot have numbers!'
                    )
